...
namespace SmartEcoAPI.Controllers
{
    ...
    public class TargetsController : ControllerBase
    {
            ...
            int? PageNumber)
        {
            ...
            {
                targets = targets.Where(t => t.Project.Id == 1);
            }
            if (role == "Almaty")
            {
            ...
            if (ProjectId != null)
            {
                targets = targets.Where(m => m.ProjectId == ProjectId);
            }
            ...
            switch (SortOrder)
            {
                ...
                case "PollutionEnvironmentDesc":
                    ...
                    break;
                case "Project":
                    targets = targets.OrderBy(k => k.Project);
                    break;
                case "ProjectDesc":
                    targets = targets.OrderByDescending(k => k.Project);
                    break;
                default:
