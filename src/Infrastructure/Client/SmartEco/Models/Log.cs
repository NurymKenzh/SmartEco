...
namespace SmartEco.Models
{
    public class Log
    {
        ...
        [Display(ResourceType = typeof(Resources.Controllers.SharedResources), Name = "DateTimeStart")]
        public DateTime DateTimeStart { get; set; }
        [Display(ResourceType = typeof(Resources.Controllers.SharedResources), Name = "DateTimeEnd")]
