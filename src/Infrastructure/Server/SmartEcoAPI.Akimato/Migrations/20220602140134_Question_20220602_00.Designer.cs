...
namespace SmartEcoAPI.Akimato.Migrations
{
    ...
    [Migration("20220602140134_Question_20220602_00")]
    partial class Question_20220602_00
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartEcoAPI.Akimato.Models.Answer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SmartEcoAPI.Akimato.Models.Ecopost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SmartEcoAPI.Akimato.Models.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SmartEcoAPI.Akimato.Models.ReceptionRecyclingPoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SmartEcoAPI.Akimato.Models.TreesByFacilityManagementMeasuresList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SmartEcoAPI.Akimato.Models.TreesByObjectTableOfTheBreedStateList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SmartEcoAPI.Akimato.Models.Answer", b =>
                {
                    b.HasOne("SmartEcoAPI.Akimato.Models.Person", "Person")
                        .WithMany()
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("SmartEcoAPI.Akimato.Models.Question", "Question")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartEcoAPI.Akimato.Models.TreesByFacilityManagementMeasuresList", b =>
                {
                    b.HasOne("SmartEcoAPI.Akimato.Models.PlantationsType", "BusinessEventsPlantationsType")
                        .WithMany()
                        .HasForeignKey("BusinessEventsPlantationsTypeId");

                    b.HasOne("SmartEcoAPI.Akimato.Models.GreemPlantsPassport", "GreemPlantsPassport")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartEcoAPI.Akimato.Models.TreesByObjectTableOfTheBreedStateList", b =>
                {
                    ...
                    b.HasOne("SmartEcoAPI.Akimato.Models.PlantationsType", "StateOfCSR15PlantationsType")
                        .WithMany()
