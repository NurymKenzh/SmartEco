...
namespace SmartEco.Controllers
{
    public class MonitoringPostsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("Id,Number,Name,TurnOnOff,NorthLatitude,EastLongitude,AdditionalInformation,MN,KazhydrometID,DataProviderId,PollutionEnvironmentId,ProjectId")] MonitoringPost monitoringPost,
            int?[] Sensors,
            string[] Minimum,
            string[] Maximum,
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Number,Name,TurnOnOff,NorthLatitude,EastLongitude,AdditionalInformation,MN,KazhydrometID,DataProviderId,PollutionEnvironmentId,ProjectId")] MonitoringPost monitoringPost,
            int?[] Sensors,
            string[] Minimum,
            string[] Maximum,
            string[] MinMeasuredValue,
